MODULE usrdef_sbc
   ...
   !!======================================================================
   !! History :  4.0   ! 2024-05  (J. Chanut) Original 
   !!----------------------------------------------------------------------

   !!----------------------------------------------------------------------
   !!   usr_def_sbc    : user defined surface bounday conditions in IWAVE case
   !!----------------------------------------------------------------------
...
CONTAINS
   ...
   SUBROUTINE usrdef_sbc_oce( kt, Kbb )
      ...
      !!
      !! ** Method  :   all 0 fields, for IWAVE case
      ...
      IF( kt == nit000 ) THEN
         !
         IF(lwp) WRITE(numout,*)' usr_sbc : IWAVE case: NO surface forcing'

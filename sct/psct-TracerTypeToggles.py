...
from psyclone.psyir.nodes     import Reference, Literal, Assignment, IfBlock, BinaryOperation, Routine
...
def trans(psyir):
    ...
    for routine in psyir.walk(Routine):
        ...
        for ts in [ 'TRA', 'TRC' ]:
            ...
            cmps = [ l.parent for l in routine.walk(Literal) if l.value == ts and isinstance(l.parent, BinaryOperation) and l.parent.operator == BinaryOperation.Operator.EQ ]
            if len(cmps) > 0:
                ...
                routine.children.insert(0, IfBlock.create(cmp, [t], [f]))
